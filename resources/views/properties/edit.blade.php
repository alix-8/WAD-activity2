                ...
                <form action="{{ route('properties.update', $property->id) }}" method="POST">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div class="mb-4">
                            ...
                            <x-text-input id="price" class="block mt-1 w-full" type="number" name="price" :value="old('price', $property->price)" required />
                            <x-input-error :messages="$errors->get('price')" class="mt-2" />
                        </div>

                        <div class="mb-4">
                            <x-input-label for="type" :value="__('Property Type')" />
                            <x-text-input id="type" class="block mt-1 w-full" type="text" name="type" :value="old('type', $property->type)" required />
                    ...
                    <div class="mt-6 border-t pt-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div class="mb-4">
                                ...
                                <x-text-input id="house_number" class="block mt-1 w-full" type="text" name="house_number" :value="old('house_number', $property->address->house_number ?? '')" required />
                                <x-input-error :messages="$errors->get('house_number')" class="mt-2" />
                            </div>

                            <div class="mb-4 md:col-span-2">
                                <x-input-label for="street" :value="__('Street')" />
                                <x-text-input id="street" class="block mt-1 w-full" type="text" name="street" :value="old('street', $property->address->street ?? '')" required />
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="city" class="block mt-1 w-full" type="text" name="city" :value="old('city', $property->address->city ?? '')" required />
